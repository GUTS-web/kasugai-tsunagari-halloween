...
| `assets/images/vendor-collaboration.webp` | 新規生成 | キッチンカー店主、クラフト作家、福祉スタッフが寺院境内で出店計画を確認する様子。明るい自然光、信頼感、地域連携。怖い装飾、文字、ロゴなし。 |
...
| `assets/images/instagram-qr.png` | ユーザー提供画像 | 出店者連絡用Instagram QR。216×216pxの正方形原寸を使用。 |
...
- 正式表記を「出店」に統一し、公開HTML・メタ情報・代替文・引継ぎ文書に旧表記が0件であることを確認
...
- ユーザーが指定した正式用語は、見出しだけでなくメタ情報・料金ラベル・代替文・FAQ・作業文書まで横断検索して統一する
- 公開URLを維持するための内部フォルダー名と、来場者に見える正式表記を分けて管理する
